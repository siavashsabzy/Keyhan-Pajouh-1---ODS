...
MODEL                := gpsModel01
MODULES              := gpsModel01_data.c gpsModel01_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := gpsModel01.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := gpsModel01_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/sabzy/myCubeSatProject;D:/sabzy/myCubeSatProject/gpsModel01_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
